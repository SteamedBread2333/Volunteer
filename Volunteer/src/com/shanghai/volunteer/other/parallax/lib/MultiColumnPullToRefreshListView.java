package com.shanghai.volunteer.other.parallax.lib;
...
public class MultiColumnPullToRefreshListView extends MultiColumnListView {
	...
	public static float getDimensionDpSize(int id, Context context,
			AttributeSet attrs) {
		TypedArray typedArray = context.obtainStyledAttributes(attrs,
				R.styleable.PullToRefreshView);
		Resources resources = context.getResources();
		DisplayMetrics metrics = resources.getDisplayMetrics();
		float dp = typedArray.getDimension(id, -1)
	...
	private void init(Context context, AttributeSet attrs) {
		...
		if (attrs == null) {
			...
			text.setTextSize(getDimensionDpSize(
					R.styleable.PullToRefreshView_ptrTextSize, context, attrs));
			...
			image.setPadding(
					0,
					0,
					(int) getDimensionDpSize(
							R.styleable.PullToRefreshView_ptrArrowMarginRight,
							context, attrs), 0);
			spinner.setPadding(
					0,
					0,
					(int) getDimensionDpSize(
							R.styleable.PullToRefreshView_ptrSpinnerMarginRight,
							context, attrs), 0);
		}
		...
		tv.setTextSize(getDimensionDpSize(
				R.styleable.PullToRefreshView_ptrTextSize, context, attrs));
	...
	protected void onScrollChanged(int l, int t, int oldl, int oldt) {
		...
		Log.i("Vingle", "hasResetHeader : " + hasResetHeader + ", t : " + t
				+ ", oldt : " + oldt);
