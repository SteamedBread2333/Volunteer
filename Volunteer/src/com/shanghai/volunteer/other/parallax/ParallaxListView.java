package com.shanghai.volunteer.other.parallax;
...
public class ParallaxListView extends ListView implements OnScrollListener {
    ...
    private ArrayList<com.shanghai.volunteer.other.parallax.OnOverScrollByListener> mOnOverScrollByList = new ArrayList<com.shanghai.volunteer.other.parallax.OnOverScrollByListener>();
    ...
    private com.shanghai.volunteer.other.parallax.OnOverScrollByListener onScroll = new com.shanghai.volunteer.other.parallax.OnOverScrollByListener() {
    ...
    private void addOnScrolledListener(com.shanghai.volunteer.other.parallax.OnOverScrollByListener onScrolled) {
